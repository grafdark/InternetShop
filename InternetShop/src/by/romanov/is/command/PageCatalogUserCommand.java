...
public class PageCatalogUserCommand implements Command {
	...
	public String execute(HttpServletRequest request) {
		...
		if (request.getParameter(PARAM_CATEGORY) != null) {
			...
			List<Goods> listGoods = goodsService.takeGoodsListCategory(
					numberPage * NUMBER_OF_PRODUCTS - NUMBER_OF_PRODUCTS, category);
			...
			List<Goods> listGoods = goodsService
					.takeGoodsList(numberPage * NUMBER_OF_PRODUCTS - NUMBER_OF_PRODUCTS);
